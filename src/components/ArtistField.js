...
const ArtistField = ({ artistProducts, onPurchaseChange: handlePurchaseChange, }) => {
    ...
    // >
    (0, jsx_runtime_1.jsxs)(react_bootstrap_1.Row, Object.assign({ className: "list-group-item", style: { display: "flex" } }, { children: [(0, jsx_runtime_1.jsxs)(react_bootstrap_1.Col, Object.assign({ as: "ul", xs: 6, sm: 3, md: 3, style: {
                    ...
                    padding: "0px 0px",
                } }, { children: (0, jsx_runtime_1.jsx)(ProductFieldCarousel_1.default, { products: products.productEntityList, onPurchaseChange: handlePurchaseChange }) }))] }), products.artist.artistId)
    // </ul>
    ));
